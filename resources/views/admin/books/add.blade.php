...
@section('main_content')  
    ...
    <section class="content-header">
      ...
      <a href="{{ route('books.index') }}" class="btn btn-success pull-right ">List</a>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-success">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" id="ajax_form" action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data">
          <div class="box-body">
            {{ csrf_field() }}

            <div class="form-group">
              <label for="post_title">Book Title</label>
              <input type="text" name="name" class="form-control" id="post_title" placeholder="Enter Book Title" value="{{ old('name') }}">
            </div>
