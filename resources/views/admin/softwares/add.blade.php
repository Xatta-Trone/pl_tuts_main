...
@section('page_title','Software add')
@section('extra_css')
...
@section('main_content')  
    ...
    <section class="content-header">
      ...
      <a href="{{ route('softwares.index') }}" class="btn btn-success pull-right ">List</a>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-success">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" id="ajax_form" action="{{ route('softwares.store') }}" method="POST" enctype="multipart/form-data">
          <div class="box-body">
            {{ csrf_field() }}

            <div class="form-group">
              <label for="post_title">Software Title</label>
              <input type="text" name="name" class="form-control" id="post_title" placeholder="Enter Software Title" value="{{ old('name') }}">
            </div>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" rows="3" id="summernote" placeholder="Enter ..." name="custom_message">{{ old('custom_message') }}</textarea>
            </div>
