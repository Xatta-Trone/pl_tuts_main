		...
		<div class="row">
			<div class="col-12 col-sm-10 col-md-6 mx-auto">
				<div class="main_message text-center">
					<a target="_blank" href="{{url(config('app.url').route('admin.password.reset', $token, false))}}" class="pl_btn">Reset Password</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-12 col-sm-10 col-md-6 mx-auto">
				<div class="main_message last">
					<p>If the link does not work then copy this url and paste in your browser <br/> <span>{{url(config('app.url').route('admin.password.reset', $token, false))}}</span></p>
					<p>If you did not make this request, just ignore this email. Otherwise, please click button above to change your password.</p>
					<p>If you have any problem or query, then send an email to <span>pltutorialsbuet@gmail.com</span> or just reply to this email. We are always happy to help you out.</p>
					<br>
					<p>Cheers</p>
