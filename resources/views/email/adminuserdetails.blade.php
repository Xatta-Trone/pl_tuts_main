		...
		<div class="row">
			<div class="col-12 col-sm-10 col-md-6 mx-auto">
				<div class="main_message">
					<p>Hi <span>{{ $adminData->name }}</span>,<br>Congratualtions, now you are an admin of PL Tutorials. Your login details are given below.</p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-12 col-sm-10 col-md-6 mx-auto">
				<div class="credential text-sm-center bg_w">
					<p>E-mail: <span>{{ $adminData->email }}</span></p>
					<p>Password: <span>{{ $adminData->password }}</span></p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-12 col-sm-10 col-md-6 mx-auto">
				<div class="main_message text-center">
					<a target="_blank" href="{{ route('admin.login') }}" class="pl_btn">Login here</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-12 col-sm-10 col-md-6 mx-auto">
				<div class="main_message last">
					<p>If you have any problem or query, then send an email to <span>pltutorialsbuet@gmail.com</span> or just reply to this email. We are always happy to help you out.</p>If the login button is not working then click on <a href="{{ route('admin.login') }}" target="_blank">{{ route('admin.login') }}</a> to login.</p>
					<br>
					<p>Cheers</p>
