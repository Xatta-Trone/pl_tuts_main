		...
		<div class="row">
			<div class="col-12 col-sm-10 col-md-6 mx-auto">
				<div class="main_message text-center">
					<a target="_blank" href="{{url(config('app.url').route('password.reset', $token, false))}}" class="pl_btn">Reset Password</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-12 col-sm-10 col-md-6 mx-auto">
				<div class="main_message last">
					<p>If the link does not work then copy this url and paste in your browser <br/> <span>{{url(config('app.url').route('password.reset', $token, false))}}</span></p>
